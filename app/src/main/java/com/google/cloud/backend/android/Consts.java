...
//  public static final String PROJECT_ID = "*** ENTER YOUR PROJECT ID ***";
  public static final String PROJECT_ID = "funciona-por-dios";

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "527856041574";

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "527856041574.apps.googleusercontent.com";
  ...
  /**
   * To check if there is route to the backend.
   */
  public static final String ENDPOINT_URL = "https://" + PROJECT_ID + ".appspot.com";
}